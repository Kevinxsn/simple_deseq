...
<p style="font-size:50px; font-weight:bold;">If you want to know how to use simple_tximort and simple_deseq quickly, please run the python notebook called tutorial under simple_deseq file! It will tell howt to use them step by step!</p>
